    ...
    try {
      ...
      if (permission == LocationPermission.denied) {
        ...
        if (permission == LocationPermission.denied) {
          setState(() {
            _error =
                'Location permissions are denied. Please grant permission to find nearby places.';
            _loading = false;
          });
          return;
        }
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          ...
          _error =
              'Failed to fetch places. Status Code: ${response.statusCode}. Please try again.';
          _loading = false;
        });
      }
    } catch (e) {
      ...
      setState(() {
        _error =
            'An unexpected error occurred: ${e.toString()}. Please check your internet connection.';
        _loading = false;
      });
    }
  }
              ...
              : Padding(
                ...
                child: Column(
                  children: [
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                            color:
                                Theme.of(
                                  context,
                                ).colorScheme.error, // Red from theme
                            fontSize: 15.0,
                    ...
                    // --- Map Section ---
                    if (_position != null &&
                        !_loading) // Only show map if location is available and not loading
                      Expanded(
                        flex: 3, // Give more space to the map
                        child: Card(
                          elevation:
                              4, // More pronounced shadow for the map card
                          shape: RoundedRectangleBorder(
                            borderRadius: BorderRadius.circular(
                              16.0,
                            ), // Rounded corners
                          ...
                          clipBehavior:
                              Clip.antiAlias, // Clip map content to rounded corners
                          child: FlutterMap(
                            options: MapOptions(
                              ...
                              initialZoom:
                                  14, // Zoom level for better visibility of nearby places
                              minZoom: 2,
                              maxZoom: 18,
                            ),
                            children: [
                              TileLayer(
                                ...
                                userAgentPackageName:
                                    'com.nomaddaily.app', // Good practice to include
                              ),
                              MarkerLayer(
                                markers: [
                                  ...
                                  Marker(
                                    ...
                                    child: Container(
                                      ...
                                      child: Icon(
                                        Icons
                                            .person_pin_circle_rounded, // User pin icon
                                        color:
                                            Colors
                                                .white, // White icon for contrast
                                        size:
                                            40, // Icon size within the container
                                      ),
                                    ),
                                  ),
                                  ...
                                  ..._nearbyPlaces.asMap().entries.map(
                                    (entry) => Marker(
                                      ...
                                      width:
                                          120, // Adjusted width for text + icon
                                      height:
                                          70, // Adjusted height for text + icon
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Icon(
                                            Icons
                                                .push_pin_rounded, // Distinct push pin icon
                                            color:
                                                Theme.of(context)
                                                    .colorScheme
                                                    .secondary, // Use secondary color for distinction
                    ...
                    if (!_loading && _nearbyPlaces.isNotEmpty)
                      Expanded(
                        flex:
                            2, // Give more space to the list if content is abundant
                        child: Column(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  ...
                                  return Card(
                                    ...
                                    elevation:
                                        1, // Subtle elevation for list items
                                    shape: RoundedRectangleBorder(
                                    ...
                                    child: ListTile(
                                      leading: Icon(
                                        Icons
                                            .store_mall_directory_rounded, // Generic place icon
                                        color: Theme.of(
                                          context,
